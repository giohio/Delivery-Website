        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white px-6 py-2 rounded-lg hover:shadow-lg transition-shadow disabled:opacity-50 disabled:cursor-not-allowed"
            >
